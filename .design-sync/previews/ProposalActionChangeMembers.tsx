import { GukModulesProvider, ProposalActionChangeMembers, ProposalActionType } from '@aragon/gov-ui-kit';
    ...
    <GukModulesProvider>
        <ProposalActionChangeMembers
            action={{
                ...
                members: [
                    { address: '0xceB69F6342eCE283b2F5c9088Ff249B5d0Ae66ea', name: 'treasury-ops.eth' },
    ...
    <GukModulesProvider>
        <ProposalActionChangeMembers
            action={{
                ...
                members: [
                    { address: '0x742d35Cc6634C0532925a3b844Bc454e4438f44e', name: 'inactive-signer.eth' },
    ...
    <GukModulesProvider>
        <ProposalActionChangeMembers
            action={{
                ...baseAction,
                type: ProposalActionType.ADD_MEMBERS,
                members: [{ address: '0x9d0920D3D7c9F28baF0abed7f2E26A5126cc0786', name: 'security-council.eth' }],
                currentMembers: 3,
            }}
            index={0}
        />
