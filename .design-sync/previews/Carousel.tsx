...
const featuredDaos = [
    { name: 'Builders Collective', members: '1.2k members', proposals: '48 proposals' },
    { name: 'Aragon Grants', members: '640 members', proposals: '31 proposals' },
    { name: 'Treasury Guild', members: '215 members', proposals: '12 proposals' },
    { name: 'Ecosystem Fund', members: '3.4k members', proposals: '96 proposals' },
    { name: 'Ops Council', members: '18 members', proposals: '54 proposals' },
];

const DaoCard = (props: { name: string; members: string; proposals: string }) => (
