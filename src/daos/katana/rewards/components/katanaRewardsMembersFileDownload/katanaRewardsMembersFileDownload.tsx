...
import type { IKatanaRewardsMembersFileDownloadDialogParams } from '../../dialogs/katanaRewardsMembersFileDownloadDialog';
import type { IKatanaRewardsMembersFileDownloadProps } from './katanaRewardsMembersFileDownload.api';

export const KatanaRewardsMembersFileDownload: React.FC<
    IKatanaRewardsMembersFileDownloadProps
> = (props) => {
    ...
    const handleClick = () => {
        ...
        const params: IKatanaRewardsMembersFileDownloadDialogParams = {
            gaugePlugin,
            network: dao.network,
            asset,
        ...
        open(KatanaRewardsDialogId.KATANA_REWARDS_MEMBERS_FILE_DOWNLOAD, {
            params,
    ...
    return (
        <InputContainer
            ...
            id="katana-rewards-members-file"
            label={t(
