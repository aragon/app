...
> = {
    ...
    [TokenPluginDialogId.EXIT_QUEUE_WITHDRAW_FEE]: {
        Component: TokenExitQueueWithdrawDialog,
    },
    [TokenPluginDialogId.EXIT_QUEUE_WITHDRAW_TRANSACTION]: {
        Component: TokenExitQueueWithdrawTransactionDialog,
    },
};
