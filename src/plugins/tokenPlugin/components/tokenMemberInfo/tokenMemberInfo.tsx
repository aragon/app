...
export const TokenMemberInfo: React.FC<ITokenMemberInfoProps> = (props) => {
    ...
    const formattedTotalSupply = formatterUtils.formatNumber(
        parsedTotalSupply,
        {
    ...
    return (
        <DefinitionList.Container>
            <DefinitionList.Item
                term={t('app.plugins.token.tokenMemberInfo.eligibleVoters')}
            >
            ...
            <DefinitionList.Item
                ...
                description={t(
                    'app.plugins.token.tokenMemberInfo.tokenNameAndSymbol',
                    {
            ...
            {formattedTotalSupply && Number(formattedTotalSupply) > 0 && (
                <DefinitionList.Item
                    term={t('app.plugins.token.tokenMemberInfo.supply')}
                >
                    <p className="text-neutral-500">
