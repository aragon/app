...
class TokenSettingsUtils {
    ...
    parseSettings = ({ settings, t }: IParseTokenSettingsParams): IDaoSettingTermAndDefinition[] => {
        ...
        if (Array.isArray(settings)) {
            ...
            const { supportThreshold, minParticipation, minDuration, minProposerVotingPower, votingMode } =
                settings.settings;
            const { symbol: tokenSymbol, totalSupply, decimals } = settings.token;
