...
import { useLockToVoteLockOnboardingCheck } from './useLockToVoteLockOnboardingCheck';

describe('useLockToVoteLockOnboardingCheck', () => {
    ...
    it('returns shouldTrigger=true when getLockedBalance=0n and balanceOf>0n', () => {
    ...
    it('returns shouldTrigger=false when getLockedBalance>0n', () => {
        useReadContractsSpy.mockReturnValue({
            data: [
