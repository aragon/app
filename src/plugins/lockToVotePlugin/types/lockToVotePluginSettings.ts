...
import type { ILockToVotePluginSettingsEscrowSettings } from './lockToVotePluginSettingsEscrowSettings';
import type { ILockToVotePluginSettingsToken } from './lockToVotePluginSettingsToken';

export interface ILockToVotePluginSettings extends IPluginSettings {
    /**
     ...
     */
    votingEscrow?: ILockToVotePluginSettingsEscrowSettings;
}
