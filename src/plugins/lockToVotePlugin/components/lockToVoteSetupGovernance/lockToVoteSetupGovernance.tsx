...
import type {
    ...
    ILockToVoteSetupGovernanceProps,
} from './lockToVoteSetupGovernance.api';

const voteDurationMin = { days: 0, hours: 1, minutes: 0 };
const voteDurationDefault = { days: 1, hours: 0, minutes: 0 };

export const LockToVoteSetupGovernance: React.FC<
    ILockToVoteSetupGovernanceProps
> = (props) => {
    const {
        formPrefix,
    ...
    const handleVoteChangeToggle = (checked: boolean) =>
        votingModeField.onChange(
            checked
                ...
                : DaoLockToVoteVotingMode.STANDARD,
        );
        ...
        <div className="flex w-full flex-col gap-y-6">
            ...
            {!isSubPlugin && (
                <InputContainer
                    ...
                    helpText={t(
                        'app.plugins.lockToVote.lockToVoteSetupGovernance.proposalDuration.helpText',
                    )}
                    id="proposalDuration"
                    label={t(
            ...
            <Switch
                ...
                helpText={t(
                    'app.plugins.lockToVote.lockToVoteSetupGovernance.voteChange.helpText',
                )}
                inlineLabel={t(
                    'app.plugins.lockToVote.lockToVoteSetupGovernance.voteChange.switch.label',
                )}
                label={t(
                    'app.plugins.lockToVote.lockToVoteSetupGovernance.voteChange.label',
                )}
