...
import type { ILockToVoteSetupMembershipForm, ILockToVoteSetupMembershipMember } from '../lockToVoteSetupMembership';

export interface ILockToVoteProposalCreationSettingsProps
...
export const LockToVoteProposalCreationSettings: React.FC<ILockToVoteProposalCreationSettingsProps> = (props) => {
    ...
    const {
        ...
        ...minVotingPowerField
    } = useFormField<ILockToVoteSetupGovernanceForm, 'minProposerVotingPower'>('minProposerVotingPower', {
