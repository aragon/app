...
export const SppInvalidAddressConnectedDialog: React.FC<
...
> = () => {
    ...
    return (
        <>
            <Dialog.Header
                title={t(
                    'app.plugins.spp.sppInvalidAddressConnectedDialog.title',
                )}
            />
            <Dialog.Content
                className="pb-4 md:pb-6"
                description={t(
                    'app.plugins.spp.sppInvalidAddressConnectedDialog.description',
                )}
            />
            <Dialog.Footer
                primaryAction={{
                    label: t(
                        'app.plugins.spp.sppInvalidAddressConnectedDialog.action',
                    ),
                    onClick: () => close(),
                }}
            />
