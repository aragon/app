...
export const MultisigUpdateSettingsAction: React.FC<
...
> = (props) => {
    ...
    const onlyListedFieldValue = useWatch<
        Record<string, IMultisigSetupGovernanceForm['onlyListed']>
    >({
    ...
    useEffect(() => {
        ...
        setValue(`${actionFieldName}.inputData.parameters[0].value`, [
            onlyListedFieldValue,
            minApprovalsFieldValue,
        ]);
    }, [
        setValue,
        actionFieldName,
