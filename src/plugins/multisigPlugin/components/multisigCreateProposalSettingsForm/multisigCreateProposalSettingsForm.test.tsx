...
import { MultisigCreateProposalSettingsForm, type IMultisigCreateProposalSettingsFormProps } from './multisigCreateProposalSettingsForm';
...
jest.mock('@/shared/components/advancedDateInput', () => ({
  AdvancedDateInput: ({ label, helpText, field, infoText, isStartField, useDuration, startTime }: IAdvancedDateInputProps) => (
...
describe('<MultisigCreateProposalSettingsForm /> component', () => {
  ...
  it('passes correct props to start time AdvancedDateInput', () => {
    ...
    expect(startTimeInput).toHaveTextContent('Label: app.plugins.multisig.createProposalSettingsForm.startTime.label');
    expect(startTimeInput).toHaveTextContent('Help Text: app.plugins.multisig.createProposalSettingsForm.startTime.helpText');
    expect(startTimeInput).toHaveTextContent('Field: app.plugins.multisig.createProposalSettingsForm.startTime.field');
    expect(startTimeInput).toHaveTextContent('Info Text: app.plugins.multisig.createProposalSettingsForm.startTime.infoText');
  ...
  it('passes correct props to end time AdvancedDateInput', () => {
    ...
    expect(endTimeInput).toHaveTextContent('Help Text: app.plugins.multisig.createProposalSettingsForm.endTime.helpText');
    expect(endTimeInput).toHaveTextContent('Field: app.plugins.multisig.createProposalSettingsForm.endTime.field');
    expect(endTimeInput).toHaveTextContent('Info Text: app.plugins.multisig.createProposalSettingsForm.endTime.infoText');
