...
import {
    generateMultisigPluginSettings,
...
describe('multisigProposal utils', () => {
    describe('getProposalStatus', () => {
        ...
        it('returns executed status when proposal has been executed', () => {
            ...
            expect(multisigProposalUtils.getProposalStatus(proposal)).toEqual(
        ...
        it('returns pending status when proposal has not started yet', () => {
            ...
            const startDate =
                DateTime.fromISO('2024-08-10T09:49:56.868Z').toMillis() / 1000;
        ...
        it('returns executable status when proposal is not ended, the approval has been reached and proposal has actions', () => {
            ...
            const startDate =
                DateTime.fromISO('2024-10-15T09:49:56.868Z').toMillis() / 1000;
            const endDate =
                DateTime.fromISO('2024-10-25T09:49:56.868Z').toMillis() / 1000;
            const proposal = generateMultisigProposal({
                startDate,
                endDate,
                hasActions: true,
        ...
        it('returns active status when proposal is started but has not ended yet', () => {
            ...
            const startDate =
                DateTime.fromISO('2024-10-08T09:49:56.868Z').toMillis() / 1000;
            const endDate =
                DateTime.fromISO('2024-10-12T09:49:56.868Z').toMillis() / 1000;
    ...
    describe('isApprovalReached', () => {
        it('returns true when number of voters is greater than min approvals', () => {
            ...
            expect(
                multisigProposalUtils.isApprovalReached(proposal),
            ).toBeTruthy();
        });
