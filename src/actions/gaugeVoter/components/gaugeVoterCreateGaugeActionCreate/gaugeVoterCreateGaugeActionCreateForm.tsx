...
import { AddressInput, addressUtils, type ICompositeAddress, type IInputFileAvatarValue, InputText, TextArea } from '@aragon/gov-ui-kit';
...
export const GaugeVoterCreateGaugeActionCreateForm: React.FC<IGaugeVoterCreateGaugeActionCreateFormProps> = (props) => {
    ...
    const { value: descriptionValue, ...descriptionFieldRest } = useFormField<IGaugeVoterCreateGaugeFormData, 'description'>(
        'description',
        {
