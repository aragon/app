...
export interface IGaugeVoterActivateGaugeActionDetailsProps extends IProposalActionComponentProps<IProposalActionData<IProposalAction>> {}
...
export const GaugeVoterActivateGaugeActionDetails: React.FC<IGaugeVoterActivateGaugeActionDetailsProps> = (props) => {
    ...
    const gaugeToActivate = gaugeAddress ? allGauges.find((gauge) => addressUtils.isAddressEqual(gauge.address, gaugeAddress)) : undefined;
