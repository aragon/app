...
export const backendApiMocks: IBackendApiMock[] = [
    {
        ...
        data: {
            data: [
                {
                    name: 'Capital Distribution Policy',
                    description: 'Distributes funds to multiple recipients based on predefined ratios',
                    links: [
                        {
                            name: 'Documentation',
                    ...
                    policyKey: 'capital-distribution-v1',
                ...
                {
                    name: 'Gauge-Based Distribution Policy',
                    description: 'Distributes funds based on gauge voting results',
                    links: [],
                    policyKey: 'gauge-distribution-v1',
