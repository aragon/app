...
import { type ITFuncOptions, type Translations, translationUtils } from '@/shared/utils/translationsUtils';
...
export const TranslationsProvider: React.FC<ITranslationsProviderProps> = (props) => {
    ...
    const contextValues = useMemo(() => ({ t: translationUtils.t(translations, displayKeys) }), [translations, displayKeys]);
