...
import { PageHeaderCustom, type IPageHeaderCustomProps } from './pageHeaderCustom';

describe('<Page.Header /> component', () => {
    const createTestComponent = (props?: Partial<IPageHeaderCustomProps>) => {
        const completeProps: IPageHeaderCustomProps = { ...props };

        return <PageHeaderCustom {...completeProps} />;
    };
