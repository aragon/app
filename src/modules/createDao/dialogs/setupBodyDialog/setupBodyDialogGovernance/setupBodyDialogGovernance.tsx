...
export const SetupBodyDialogGovernance: React.FC<
    ISetupBodyDialogGovernanceProps
> = (props) => {
    ...
    const membershipSettings = useWatch<
        Record<string, ISetupBodyFormNew['membership']>
    >({ name: 'membership' });
