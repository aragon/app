import { CreateProcessFormTokenVotingCreateToken } from '@/modules/createDao/components/createProcessForm/createProcessFormPluginFlows/createProcessFormTokenVotingFlow/createProcessFormTokenVotingDistro/createProcessFormTokenVotingCreateToken';
import { CreateProcessFormTokenVotingImportToken } from '@/modules/createDao/components/createProcessForm/createProcessFormPluginFlows/createProcessFormTokenVotingFlow/createProcessFormTokenVotingDistro/createProcessFormTokenVotingImportToken';
...
export const CreateProcessFormTokenVotingDistro: React.FC<ICreateProcessFormTokenVotingDistroProps> = (props) => {
    ...
    return (
        <>
            ...
            {tokenType === 'imported' && <CreateProcessFormTokenVotingImportToken fieldPrefix={fieldPrefix} />}
            {tokenType === 'new' && <CreateProcessFormTokenVotingCreateToken fieldPrefix={fieldPrefix} />}
        </>
    );
};
