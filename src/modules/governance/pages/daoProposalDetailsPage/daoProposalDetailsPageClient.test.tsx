...
describe('<DaoProposalDetailsPageClient /> component', () => {
    ...
    it('renders the member information', () => {
        ...
        expect(screen.getByText(/daoProposalPage.aside.details.title/)).toBeInTheDocument();

        expect(screen.getByText(/daoProposalPage.aside.details.address/)).toBeInTheDocument();
        ...
        expect(screen.getByText(/daoProposalPage.aside.details.ens/)).toBeInTheDocument();
        ...
        expect(screen.getByText(/daoProposalPage.aside.details.firstActivity/)).toBeInTheDocument();
    });

    it('renders the formatted member stats', () => {
        render(createTestComponent());

        expect(screen.getByText(/daoProposalPage.header.stat.latestActivity/)).toBeInTheDocument();
    });
});
