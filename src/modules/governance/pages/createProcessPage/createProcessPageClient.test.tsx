...
import { CreateProcessPageClient, type ICreateProcessPageClientProps } from './createProcessPageClient';

jest.mock('./createProcessPageClientSteps', () => ({
    CreateProcessPageClientSteps: () => <button data-testid="steps-mock" type="submit" />,
}));
...
describe('<CreateProcessPageClient /> component', () => {
    ...
    const createTestComponent = (props?: Partial<ICreateProcessPageClientProps>) => {
        const completeProps: ICreateProcessPageClientProps = {
            daoId: 'test',
            ...props,
        };

        return <CreateProcessPageClient {...completeProps} />;
    };
