...
export const generateCreateProposalStartDateFormData = (values?: Partial<ICreateProposalStartDateForm>): ICreateProposalStartDateForm => ({
    startTimeMode: 'now',
    ...values,
});

export const generateCreateProposalEndDateFormData = (values?: Partial<ICreateProposalEndDateForm>): ICreateProposalEndDateForm => ({
