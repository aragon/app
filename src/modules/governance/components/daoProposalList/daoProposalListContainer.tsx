...
import type { ITabComponentPlugin } from '@/shared/components/pluginTabComponent/pluginTabComponent.api';
...
export const DaoProposalListContainer: React.FC<IDaoProposalListContainerProps> = (props) => {
    ...
    let processedPlugins: Array<ITabComponentPlugin<IDaoPlugin>> | undefined = processPlugins?.map((plugin) => {
        ...
        return { ...plugin, props: { initialParams: pluginInitialParams as IGetProposalListParams, plugin: plugin.meta } };
    });
