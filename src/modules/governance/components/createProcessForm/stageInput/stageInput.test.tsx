...
import type { IStageInputProps } from './stageInput.api';

describe('<StageInput /> component', () => {
    const createTestComponent = (props?: Partial<IStageInputProps>) => {
        const completeProps: IStageInputProps = { name: 'resources', helpText: 'helpful text', ...props };
        return (
            <FormWrapper>
                <StageInput {...completeProps} />
            </FormWrapper>
        );
    };
