...
import { type IStageInputItemProps, StageInputItem } from './stageInputItem';

describe('<StageInputItem /> component', () => {
    ...
    const createTestComponent = (props?: Partial<IStageInputItemProps>) => {
        const completeProps: IStageInputItemProps = {
            name: 'resources',
            index: 0,
            remove: jest.fn(),
            ...props,
