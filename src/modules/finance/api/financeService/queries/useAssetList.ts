...
export const assetListOptions = (
    ...
    options?: InfiniteQueryOptions<IPaginatedResponse<IBalance>, IGetAssetListParams>,
): SharedInfiniteQueryOptions<IPaginatedResponse<IBalance>, IGetAssetListParams> => ({
