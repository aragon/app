...
import { type ISetupStrategyForm, StrategyType } from '../setupStrategyDialogDefinitions';

export const SetupStrategyDialogSelect: React.FC = () => {
    const { t } = useTranslations();

    const { onChange: onStrategyTypeFieldChange, ...strategyTypeField } = useFormField<ISetupStrategyForm, 'type'>('type', {
    ...
    return (
        ...
        >
            ...
            <RadioCard
                ...
                tag={{
                    variant: 'info',
                    label: t('app.capitalFlow.setupStrategyDialog.select.disabled.onRequest'),
                }}
            ...
            <RadioCard
                ...
                tag={{
                    variant: 'info',
                    label: t('app.capitalFlow.setupStrategyDialog.select.disabled.soon'),
                }}
