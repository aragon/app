...
import { Children, type ComponentProps, useContext } from 'react';
...
export const TabsList: React.FC<ITabsListProps> = (props) => {
    ...
    const tabsListClassNames = classNames('flex gap-x-6', { 'border-neutral-100 border-b': isUnderlined }, className);
