    ...
    describe('number formatting', () => {
        ...
        describe('percentages', () => {
            test.each([
                ...
                { value: -0.000_001, result: '-0.0001%' },
                { value: -0.000_000_012_345, result: '-0.0000012%' },
                { value: 0, result: '0.00%' },
                { value: 0, result: '0.00%', withSign: true },
                { value: 0.000_000_012_345, result: '0.0000012%' },
                { value: 0.000_000_999, result: '0.0001%' },
                { value: 0.000_001, result: '0.0001%' },
                { value: 0.000_001, result: '+0.0001%', withSign: true },
                { value: 0.000_012_345, result: '0.0012%' },
                { value: 0.000_123_45, result: '0.01%' },
            ...
            test.each([
                ...
                { value: -0.000_001, result: '-0.0001%' },
                { value: 0, result: '0%' },
                { value: 0.000_000_012_345, result: '0.000001%' },
                { value: 0.000_001, result: '0.0001%' },
                { value: 0.000_001, result: '+0.0001%', withSign: true },
                { value: 0.000_012_345, result: '0.001%' },
                { value: 0.000_123_45, result: '0.01%' },
                { value: 0.000_123_45, result: '+0.01%', withSign: true },
    ...
    describe('date formatting', () => {
        ...
        describe('RELATIVE format', () => {
            test.each([
                ...
                { value: '2004-10-26T20:21:22', result: 'in 1 day', now: '2004-10-25T20:21:23' },
                { value: '2004-10-26T20:21:23', result: 'in 1 day', now: '2004-10-25T20:21:23' },
                { value: '2004-11-24T20:21:23', result: 'in 1 month', now: '2004-10-25T20:21:23' },
                { value: '2004-11-29T12:12:41', result: 'in 1 month', now: '2004-10-25T20:21:23' },
                { value: '2011-10-10T11:01:00', result: 'in 2 years', now: '2010-04-10T11:01:00' },
                { value: '2019-11-20T11:01:00', result: 'in 10 years', now: '2010-04-10T11:01:00' },
