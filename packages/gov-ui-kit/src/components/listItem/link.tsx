...
export const ListItemLink: React.FC<ListItemLinkProps> = ({ external = true, ...props }) => {
    return (
        <Container>
            <Link
...
const Title = styled.p.attrs({
    className: 'tablet:max-w-xs max-w-full overflow-hidden font-bold truncate whitespace-nowrap',
})``;
