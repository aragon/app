...
export const DropdownInput: React.FC<DropDownInputProps> = ({
    ...
    return (
        <Container data-testid="dropdown-input" {...{ mode, name, disabled, onClick }}>
...
const Container = styled.button.attrs(({ mode, disabled }: StyledContainerProps) => {
...
const StyledIconChevronDown = styled(IconChevronDown).attrs(({ disabled }: StyledChevronDownProps) => ({
