...
const MenuBar: React.FC<MenuBarProps> = ({ editor, disabled, isExpanded, setIsExpanded, fullScreen = false }) => {
...
export const TextareaWYSIWYG: React.FC<TextareaWYSIWYGProps> = ({
    ...
    return (
        <Container disabled={disabled}>
            <MenuBar disabled={disabled} editor={editor} isExpanded={isExpanded} setIsExpanded={setIsExpanded} />
            <StyledEditorContent name={name} editor={editor} />
        </Container>
    );
};
