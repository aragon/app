...
type SizesType = Record<NonNullable<AvatarWalletProps['size']>, { style: string; scale: number }>;
...
export const AvatarWallet: React.FC<AvatarWalletProps> = ({ src, size = 'medium' }) => {
