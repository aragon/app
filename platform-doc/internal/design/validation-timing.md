...
Keep a failed check in the part of the flow where the person can repair it. Show the [wizard](../../application/wizard.md) step's blocking fields and preserve useful input while the person corrects them.
