...
status: draft
source: app interaction-principles inventory against app@122f1bd1 + product-owner review + gov-ui-kit v2.9.0 verification (2026-08-05, see log.md) + classification verification at app@adad67873c8f9dd75e3ed340b70df3e985ae3557 (2026-09-13, see log.md) with locked gov-ui-kit@2.11.4 and @tiptap/extension-link@3.30.3
---
...
A standalone resource has room for both pieces of information. Show its supplied name as the link label and the resolved URL or destination underneath. Proposal resources, plugin metadata, and [member-profile links](../../governance/member.md#member-page) use this treatment: a label such as **Website** or **Budget breakdown** remains readable while the destination stays visible.
