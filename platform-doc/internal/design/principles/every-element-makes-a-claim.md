...
tags: [principles, design, interaction, content, cross-cutting]
status: draft
source: product-owner briefing (2026-07-29, see log.md) + product-owner semantic-anchor review (2026-09-10, see log.md)
---
...
Absent content makes a claim too: an empty collection and a failed load say different things about the product, and the [datalist page](../../../application/collection-pages.md) states the distinct states that keep those claims honest.
