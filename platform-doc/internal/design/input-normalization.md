...
| A valid account or contract address | Convert it to the validated checksum form through the shared [address input](../../application/address-input.md). | The checksum form represents the same address and makes mistyped mixed case detectable. |
