...
- Resolve every supported finding on its pages. Keep any missing decision or verification in a finite task with affected-page links and one actor-appropriate board row; do not recreate page-question checkboxes.
