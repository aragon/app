...
export const WizardPageContainerProgress = (
    props: IWizardPageContainerProgressProps,
) => {
    ...
    const nextStepName = hasNext
        ? steps[activeStepIndex + 1]?.meta.name
        : finalStep;
            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-row gap-1 font-normal text-base leading-tight">
                    <span className="text-primary-400">
                        {t('app.shared.wizardPage.container.step', {
                            number: activeStepIndex + 1,
                        })}
                    </span>
                    <span className="text-neutral-500">
                        {t('app.shared.wizardPage.container.total', {
                            total: steps.length,
                        })}
                    </span>
                </div>
                {nextStepName != null && (
                    <div className="flex flex-row gap-1 font-normal text-base leading-tight">
                        <span className="text-neutral-500">
                            {t('app.shared.wizardPage.container.next')}
                        </span>
