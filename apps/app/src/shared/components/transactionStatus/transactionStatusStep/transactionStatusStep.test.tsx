...
describe('<TransactionStatusStep /> component', () => {
    const createTestComponent = (
        props?: Partial<ITransactionStatusStepProps>,
    ) => {
    ...
    it('renders a spinner on idle state', () => {
        render(
            createTestComponent({
                meta: { label: '', state: 'idle' as const },
            }),
        );
    ...
    it('renders a spinner on pending state', () => {
        render(
            createTestComponent({
                meta: { label: '', state: 'pending' as const },
            }),
        );
        expect(screen.getByRole('progressbar')).toBeInTheDocument();
    });
    ...
    it('renders a warning icon on warning state', () => {
        render(
            createTestComponent({
                meta: { label: '', state: 'warning' as const },
            }),
        );
    ...
    it('renders a critical icon on error state', () => {
        render(
            createTestComponent({
                meta: { label: '', state: 'error' as const },
            }),
        );
    ...
    it('renders a success icon on success state', () => {
        render(
            createTestComponent({
                meta: { label: '', state: 'success' as const },
            }),
        );
    ...
    it('renders a link when the addon property is a link', () => {
        ...
        render(createTestComponent({ meta }));
        expect(
            screen.getByRole('link', { name: meta.addon.label }),
        ).toBeInTheDocument();
    });
