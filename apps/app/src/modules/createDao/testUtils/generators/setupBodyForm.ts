...
export const generateSetupBodyFormBase = (
    data?: Partial<ISetupBodyFormBase>,
): ISetupBodyFormBase => ({
    internalId: '0',
    plugin: 'plugin-name',
    type: BodyType.NEW,
...
export const generateSetupBodyFormNew = (
    data?: Partial<ISetupBodyFormNew>,
): ISetupBodyFormNew => ({
...
export const generateSetupBodyFormExternal = (
    data?: Partial<ISetupBodyFormExternal>,
): ISetupBodyFormExternal => ({
    ...generateSetupBodyFormBase(data),
...
export const generateSetupBodyFormExisting = (
    data?: Partial<ISetupBodyFormExisting>,
): ISetupBodyFormExisting => ({
    ...generateSetupBodyFormBase(data),
...
export const generateSetupBodyFormData = (
    data?: Partial<ISetupBodyForm>,
): ISetupBodyForm => {
