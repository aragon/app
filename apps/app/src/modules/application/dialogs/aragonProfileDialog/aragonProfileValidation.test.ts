...
describe('socialFieldRules', () => {
    ...
    describe('email', () => {
        ...
        it.each(['alice', 'alice@', 'alice@example', 'a b@example.com'])(
    ...
    describe('website', () => {
        it.each(['https://aragon.org', 'http://aragon.org/path'])(
        ...
        it.each(['not a url', 'ftp://aragon.org', 'javascript:alert(1)'])(
            'rejects non-http(s) value "%s"',
            (value) => {
    ...
    describe('github', () => {
        ...
        it.each(['-octocat', 'octocat-', 'user/repo', 'foo bar'])(
    ...
    describe('twitter', () => {
        it.each(['vitalik', '@vitalik', 'vitalik_eth'])(
        ...
        it.each(['foo bar', 'waytoolonghandle12345', 'a.b'])(
    ...
    describe('telegram', () => {
        ...
        it.each(['abc', 'foo bar', 'a'.repeat(33)])(
            'rejects invalid handle "%s"',
            (value) => {
    ...
    describe('discord', () => {
        it.each(['aragon', 'aragon.dao', 'a_b.c'])(
            'accepts valid username "%s"',
            (value) => {
