...
import { TokenVotingOptions } from './tokenVotingOptions';

export interface ITokenSubmitVoteDefaultProps {
    /**
...
export const TokenSubmitVoteDefault: React.FC<ITokenSubmitVoteDefaultProps> = (
    props,
) => {
